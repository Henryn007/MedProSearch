    ...
    if(  is_page() || is_page_template( 'template-builder.php' )  ) {
        if( $medixi_page_breadcrumb_area == '1' ) {
            if( class_exists( 'reduxframework' ) ){
                $breadcrumb_img = medixi_opt('medixi_allHeader_bg', 'url');
            }else{
                $breadcrumb_img = "";
            }
            echo '<!-- Page title -->';
            echo '<div class="breadcumb-wrapper" id="breadcumbwrap" data-bg-src="'.esc_url($breadcrumb_img).'">';
                echo '<div class="container z-index-common">';
                    echo '<div class="breadcumb-content">';
                        if( defined('CMB2_LOADED') || class_exists('ReduxFramework') ) {
                            if( !empty( medixi_meta('page_breadcrumb_settings') ) ) {
            ...
            if( $medixi_breadcrumb_switcher == '1' && (  is_page() || is_page_template( 'template-builder.php' ) )) {
                medixi_breadcrumbs(
                    array(
                            ...
                            if( class_exists('ReduxFramework') ){
                                if( $medixi_blog_page_title_switcher ){
                                    echo medixi_heading_tag(
                                        array(
                                            "tag"   => esc_attr( $medixi_page_title_tag ),
                                            "text"  => !empty( $medixi_blog_page_custom_title ) && $medixi_blog_page_title_setting == 'custom' ? esc_html( $medixi_blog_page_custom_title) : esc_html__( 'Latest News', 'medixi' ),
                                            'class' => 'breadcumb-title'
                                        )
                                    );
                                }
                                ...
                                echo medixi_heading_tag(
                                    array(
                                        "tag"   => "h1",
                                        "text"  => esc_html__( 'Latest News', 'medixi' ),
                                        'class' => 'breadcumb-title',
                                    )
                                );
                            }
