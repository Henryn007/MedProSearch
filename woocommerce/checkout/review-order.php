...
<table class="shop_table woocommerce-checkout-review-order-table cart_table mb-20">
	<thead>
		<tr>
			...
			<th class="cart-col-price"><?php esc_html_e( 'Price', 'medixi' ); ?></th>
	...
	<tfoot class="checkout-ordertable">
		<tr class="cart-subtotal">
			<th><?php esc_html_e( 'Subtotal', 'medixi' ); ?></th>
			<td data-title="<?php echo esc_attr__( 'Subtotal', 'medixi' );?>" colspan="6"><?php wc_cart_totals_subtotal_html(); ?></td>
		</tr>
		...
		<tr class="order-total">
			<th><?php esc_html_e( 'Total', 'medixi' ); ?></th>
			<td data-title="<?php echo esc_attr__( 'Total', 'medixi' );?>" colspan="6"><?php wc_cart_totals_order_total_html(); ?></td>
		</tr>
