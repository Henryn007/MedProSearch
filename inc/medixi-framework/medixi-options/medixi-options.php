<?php
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            ...
            array(
                'id'       => 'medixi_allHeader_bg',
                'type'     => 'media',
                'title'    => esc_html__( 'Breadcrumb Image', 'medixi' ),
                'subtitle' => esc_html__( 'Setting page header background. If you use this option then you will able to set Background Color, Background Image, Background Repeat, Background Size, Background Attachment, Background Position.', 'medixi' ),
            ),
            array(
