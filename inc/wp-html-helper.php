...
// image default alt
if( !function_exists( 'medixi_img_default_alt' ) ){
	function medixi_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'medixi_img_tag' ) ){
	function medixi_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = medixi_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'medixi_anchor_tag' ) ){
	function medixi_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'medixi_heading_tag' ) ){
	function medixi_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'medixi_paragraph_tag' ) ){
	function medixi_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'medixi_span_tag' ) ){
	function medixi_span_tag( array $args ){
