...
if ( ! function_exists( 'medixi_breadcrumbs' ) ) {
    function medixi_breadcrumbs( $args = array() ) {
        ...
        */
        ...
        $html = '';
        $html .= '<div class="breadcumb-menu-wrap container" data-sec-pos="top-half" data-pos-for="#breadcumbwrap">';
        ...
        if ( is_singular( 'post' ) ) {
            ...
            $html .= '<li class="active bread-search">'.esc_html__('Search results for: ','medixi') . get_search_query() . '</li>';
        } elseif ( is_404() ) {
            $html .= '<li>' . esc_html__( 'Error 404', 'medixi' ) . '</li>';
        } elseif ( is_home() ) {
