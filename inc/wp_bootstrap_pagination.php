...
function medixi_pagination( $args = array() ) {
    
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'medixi' ),
        'next_string'     => esc_html__( '&raquo;', 'medixi' ),
        'before_output'   => '',
        'after_output'    => ''
    );
    ...
    $args = wp_parse_args( 
        $args, 
        apply_filters( 'medixi_pagination_defaults', $defaults )
    );
